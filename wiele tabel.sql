...
a.WORKING_AREA, b.AGENT_NAME AS "Salesman", b.COMMISSION
FROM customer a
INNER JOIN agents b
ON a.AGENT_CODE=b.AGENT_CODE
WHERE b.COMMISSION>.12;

SELECT a.ORD_NUM, a.ORD_DATE,a.ORD_AMOUNT,
b.cust_name AS "Customer Name", c.AGENT_NAME AS "Salesman", c.commission
FROM orders a
...
SELECT a.cust_name,a.WORKING_AREA, b.AGENT_NAME AS "Salesman", b.working_area
FROM customer a
RIGHT OUTER JOIN agents as b
...
FROM agents a
CROSS JOIN customer b
WHERE a.WORKING_AREA IS NOT NULL
AND b.grade IS NOT NULL
AND a.WORKING_AREA<>b.WORKING_AREA;

SELECT AGENT_CODE "ID", AGENT_NAME, 'Salesman' as “Rodzaj”
FROM agents
WHERE WORKING_AREA='London'
UNION
(SELECT cust_code "ID", cust_name, 'Customer' as “Rodzaj”
FROM customer
WHERE WORKING_AREA='London');
